...
define('TEXT_PRODUCTS_ABFS', '<b>ABFS Shipping Information</b>');
define('TEXT_PRODUCTS_ABFS_CLASS', 'Freight Class:');
define('TEXT_PRODUCTS_ABFS_DIMENSIONS', 'Dimensions (feet):');
define('TEXT_PRODUCTS_ABFS_NMFC', 'NMFC: (optional)');
