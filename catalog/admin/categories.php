...
//---ABFS Modification START ---//
                                  'products_abfs_class' => tep_db_prepare_input($HTTP_POST_VARS['products_abfs_class']),
                                  'products_abfs_length' => tep_db_prepare_input($HTTP_POST_VARS['products_abfs_length']),
                                  'products_abfs_width' => tep_db_prepare_input($HTTP_POST_VARS['products_abfs_width']),
                                  'products_abfs_height' => tep_db_prepare_input($HTTP_POST_VARS['products_abfs_height']),
                                  'products_abfs_nmfc' => tep_db_prepare_input($HTTP_POST_VARS['products_abfs_nmfc']),
//---ABFS Modification END ---//
...
//---ABFS Modification START ---//	
                       'products_abfs_class' => '',
                       'products_abfs_length' => '',
                       'products_abfs_width' => '',
                       'products_abfs_height' => '',
                       'products_abfs_nmfc' => '',
//---ABFS Modification END ---//
                       'manufacturers_id' => ''); 
...
//---ABFS Modification START ---//
      ...
      $product_query = tep_db_query("select pd.products_name, pd.products_description, pd.products_url, p.products_id, p.products_quantity, p.products_model, p.products_image, p.products_price, p.products_weight, p.products_date_added, p.products_last_modified, date_format(p.products_date_available, '%Y-%m-%d') as products_date_available, p.products_status, p.products_tax_class_id, p.manufacturers_id, p.products_abfs_length, p.products_abfs_width, p.products_abfs_height, p.products_abfs_class, p.products_abfs_nmfc from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd where p.products_id = '" . (int)$HTTP_GET_VARS['pID'] . "' and p.products_id = pd.products_id and pd.language_id = '" . (int)$languages_id . "'");
//---ABFS Modification END ---//
      $product = tep_db_fetch_array($product_query);
...
<? //---ABFS Modification START ---// ?>
          <? if (MODULE_SHIPPING_ABFS_STATUS == 'True') { 
               $frc_array = array(array('id' => '50', 'text' => '050'),
                                  array('id' => '55', 'text' => '055'),
                                  array('id' => '60', 'text' => '060'),
                                  array('id' => '65', 'text' => '065'),
                                  array('id' => '70', 'text' => '070'),
                                  array('id' => '77.5', 'text' => '77.5'),
                                  array('id' => '85', 'text' => '085'),
          ...
          ?>
          <tr bgcolor="#ebebff">
            <td class="main" colspan=2 style="border-bottom:1px solid #000000"><?php echo TEXT_PRODUCTS_ABFS; ?></td>
          </tr>
          <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_ABFS_CLASS; ?></td>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_pull_down_menu('products_abfs_class', $frc_array, $pInfo->products_abfs_class); ?></td>
          </tr>
          <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_ABFS_DIMENSIONS; ?></td>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('products_abfs_length', $pInfo->products_abfs_length, 'maxlength=3 style="width:50px"') . 'L x ' . tep_draw_input_field('products_abfs_width', $pInfo->products_abfs_width, 'maxlength=3 style="width:50px"') . 'W x ' . tep_draw_input_field('products_abfs_height', $pInfo->products_abfs_height, 'maxlength=3 style="width:50px"') . 'H'; ?></td>
          </tr>
          <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_ABFS_NMFC; ?></td>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('products_abfs_nmfc', $pInfo->products_abfs_nmfc, 'maxlength=100'); ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
